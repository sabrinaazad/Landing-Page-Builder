<section class="section section--sbs-image-list" id="<?php echo the_sub_field('id'); ?>">
    ...
    <style>
         .section--sbs-image-list .two-col .col .list li {
        ...
        .section--sbs-image-list .two-col .col .list li::after {
            background-image: url(<?php echo the_sub_field('checkmark');  ?>);
        }
    </style>
</section>