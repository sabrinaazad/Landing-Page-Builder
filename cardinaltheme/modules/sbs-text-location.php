...
?>
<section class="section section--sbs-text-location full-width no-padded-sides <?php echo $reverse; ?>" 
<?php 
...
id="<?php echo the_sub_field('id'); ?>">
    <div class="two-col">
        ...
        <?php if (have_rows('right')) : while (have_rows('right')) : the_row(); ?>
            <div class="col">
                <div class="location-wrapper" style="background-color: <?php echo the_sub_field('background_color');?>;">
                    <div class="map">
